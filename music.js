...
setInterval(() => {
  http.get(`http://quraaaaaaan.glitch.me/`); //تعديل مهم حط اسم المشروع
}, 280000);
...
const GUILDID = '748207784708931676'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '754924908898943086'; // تعديل مهم ايدي الروم الصوتي
...
//تغير الحالة
const developers = ["290544555542052864","","",""] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
...
const youtube = new YouTube("AIzaSyB9bbUz6NCCy5owY9WmzD2nEEe-OzGGWVo"); //تعديل مهم عدل الاي بي اي بواحد جديد او خليه زي ماهو
